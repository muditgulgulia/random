...
(function () {
    function C(c) {
        return c.type == CKEDITOR.NODE_TEXT && 0 < c.getLength() && (!r || !c.isReadOnly())
    }
    ...
    function q(c, g) {
        function n(a, b) {
            ...
            c.guard = b ? w : function (a) {
                !w(a) && (d._.matchBoundary = !0)
            };
            c.evaluator = C;
            c.breakOnFalse = 1;
            a.startContainer.type == CKEDITOR.NODE_TEXT && (this.textNode = a.startContainer, this.offset = a.startOffset -
                1);
        ...
        var x = new CKEDITOR.style(CKEDITOR.tools.extend({
            attributes: {"data-cke-highlight": 1}, fullMatch: 1,
            ignoreReadonly: 1, childRule: function () {
                return 0
            }
        ...
        var D = /[.,"'?!;: \u0085\u00a0\u1680\u280e\u2028\u2029\u202f\u205f\u3000]/,
            A = function (a) {
                ...
                searchRange: null, matchRange: null, find: function (a, b, d, f, e, E) {
                    this.matchRange ? (this.matchRange.removeHighlight(), this.matchRange = this.matchRange.getNextCharacterRange(a.length)) : this.matchRange = new u(new n(this.searchRange), a.length);
                    for (var k = new z(a, !b), l = 0, m = "%"; null !== m;) {
                        ...
                        if (2 == l) {
                            if (d) {
                                var h = this.matchRange.getCursors(), p = h[h.length - 1], h = h[0], g = c.createRange();
                    ...
                    return f && !E ? (this.searchRange = t(1), this.matchRange = null,
                    ...
                    if (!this.matchRange || !this.matchRange.isMatched() || this.matchRange._.isReplaced || this.matchRange.isReadOnly() || a)a && this.matchRange && (this.matchRange.clearMatched(), this.matchRange.removeHighlight(), this.matchRange = null), a = this.find(b, f, e, g, !k); else {
                        this.matchRange.removeHighlight();
                    ...
                    r = 0;
                    return a
                }, matchOptions: null, hasMatchOptionsChanged: function (a, b, c) {
                    a = [a, b, c].join(".");
        ...
        return {
                ...
                id: "find", label: f.find, title: f.find, accessKey: "", elements: [{
                    ...
                    children: [{
                        ...
                        onClick: function () {
                            ...
                            e.find(a.getValueOf("find", "txtFindFind"), a.getValueOf("find", "txtFindCaseChk"),
                    ...
                    children: [{
                        ...
                        children: [{
                            ...
                            isChanged: !1,
                            label: f.matchWord
                        }, {type: "checkbox", id: "txtFindCyclic", isChanged: !1, "default": !0, label: f.matchCyclic}]
                    }]
                }]
            }, {
                id: "replace",
                label: f.replace, accessKey: "M", elements: [{
                    type: "hbox",
                    widths: ["230px", "90px"],
                    children: [{
                        type: "text",
                        ...
                        onClick: function () {
                            var a = this.getDialog();
                            e.replace(a, a.getValueOf("replace", "txtFindReplace"), a.getValueOf("replace", "txtReplace"), a.getValueOf("replace", "txtReplaceCaseChk"), a.getValueOf("replace", "txtReplaceWordChk"), a.getValueOf("replace",
                    ...
                    children: [{
                        ...
                        onClick: function () {
                            ...
                            for (c.fire("saveSnapshot"); e.replace(a, a.getValueOf("replace",
                                "txtFindReplace"), a.getValueOf("replace", "txtReplace"), a.getValueOf("replace", "txtReplaceCaseChk"), a.getValueOf("replace", "txtReplaceWordChk"), !1, !0););
                    ...
                    type: "fieldset", label: CKEDITOR.tools.htmlEncode(f.findOptions), children: [{
                        type: "vbox",
                        padding: 0,
                        children: [{type: "checkbox", id: "txtReplaceCaseChk", isChanged: !1, label: f.matchCase}, {
                            type: "checkbox", id: "txtReplaceWordChk", isChanged: !1,
                            label: f.matchWord
                        }, {
                            type: "checkbox",
                            id: "txtReplaceCyclic",
                ...
                this.selectPage = CKEDITOR.tools.override(this.selectPage, function (f) {
                    return function (e) {
                        ...
                        if (c) {
                            var l;
                            e = "find" === e ? 1 : 0;
                            var g = 1 - e, m, h = v.length;
                            for (m = 0; m < h; m++)k = this.getContentElement(B[e], v[m][e]), l = this.getContentElement(B[g], v[m][g]), l.setValue(k.getValue())
                        }
                    }
                })
            },
            ...
            onHide: function () {
                var a;
                e.matchRange && e.matchRange.isMatched() && (e.matchRange.removeHighlight(), (a = e.matchRange.toDomRange()) && c.getSelection().selectRanges([a]), c.focus());
                delete e.matchRange
            },
            onFocus: function () {
    ...
    var r, y = function () {
        ...
        v = [["txtFindFind", "txtFindReplace"], ["txtFindCaseChk", "txtReplaceCaseChk"], ["txtFindWordChk", "txtReplaceWordChk"], ["txtFindCyclic", "txtReplaceCyclic"]];
